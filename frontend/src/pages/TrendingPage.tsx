import { Calendar, Clock, Download, Eye, Flame, Star, TrendingUp } from 'lucide-react';
  ...
  const trendingDocuments: TrendingDocument[] = [
    {
      ...
      description:
        'Comprehensive guide to advanced React patterns including hooks, context, and performance optimization.',
      language: 'en',
  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">Documents gaining momentum</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {Math.round(
                    trendingDocuments.reduce((acc, doc) => acc + doc.trendingChange, 0) /
                      trendingDocuments.length
                  )}
                  %
                </p>
              </div>
            ...
            <p className="text-sm text-muted-foreground mt-1">Average trending change</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">Documents with 90+ score</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="flex justify-center">
        <Button variant="outline">Load More Trending Documents</Button>
      </div>
    </div>
  );
}
