...
export class DocumentsService {
  ...
  async createDocument(
    ...
    // Delegate to DocumentCrudService which handles synchronous similarity detection
    this.logger.log(
      `Delegating createDocument to DocumentCrudService for user ${userId}`,
    );
    return this.crudService.createDocument(createDocumentDto, userId);
  }
